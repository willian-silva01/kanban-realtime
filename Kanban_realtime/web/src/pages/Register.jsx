...
const S = {
  ...
  subtitle: { color: '#8E9BAE', fontSize: '14px', margin: 0, lineHeight: 1.5 },
  errorBox: {
    display: 'flex',
    alignItems: 'center',
    gap: '10px',
  ...
  inputIcon: { position: 'absolute', left: '14px', color: '#8E9BAE', pointerEvents: 'none' },
  input: {
    width: '100%',
  ...
  footer: { color: '#8E9BAE', textAlign: 'center', marginTop: '28px', fontSize: '14px' },
